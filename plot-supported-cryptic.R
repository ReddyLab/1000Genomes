...
plot(h1,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,0.4),xlab=x,ylab=y,freq=F,main="Simulated cryptic-site isoforms supported by at least one spliced read");
plot(h2,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,0.4),xlab=x,ylab=y,freq=F,main="ICE cryptic-site isoforms supported by at least one spliced read");
dev.off();
