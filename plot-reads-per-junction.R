...
plot(h1,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,90),xlab=x,ylab=y,freq=F,main="Reads per novel junction in simulated isoforms");
plot(h2,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,90),xlab=x,ylab=y,freq=F,main="Reads per novel junction in ICE isoforms");
dev.off();
