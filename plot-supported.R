...
plot(h1,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,0.5),ylim=c(0,0.22),xlab=x,ylab=y,freq=F,main="Simulated isoforms supported by at least one read");
plot(h2,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,0.5),ylim=c(0,0.22),xlab=x,ylab=y,freq=F,main="ICE isoforms supported by at least one read");
dev.off();
