...
open(EFFECT,">effect-sizes.fpkm2") || die;
open(EFFECT0,">effect-sizes-homo.fpkm2") || die;
open(EFFECT1,">effect-sizes-het.fpkm2") || die;
open(LOG,">effect-sizes-log.fpkm2") || die;
open(LOG0,">effect-sizes-log-homo.fpkm2") || die;
open(LOG1,">effect-sizes-log-het.fpkm2") || die;
