...
plot(h1,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,1),xlab=x,ylab=y,freq=F,main="Supported exon-skipping isoforms when ICE predictions\nare not provided to TopHat");
plot(h2,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,1),xlab=x,ylab=y,freq=F,main="Supported exon-skipping isoforms when ICE predictions\nare provided to TopHat");
dev.off();
