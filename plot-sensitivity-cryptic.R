...
y <- "Frequency";
outfile <- "sensitivity-cryptic.pdf"
...
plot(h1,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,0.3),xlab=x,ylab=y,freq=F,main="ICE-predicted cryptic-site isoforms found by StringTie\nwithout access to ICE predictions");
plot(h2,col=rgb(0.1,0.1,0.1,1/4),xlim=c(0,0.3),xlab=x,ylab=y,freq=F,main="ICE-predicted cryptic-site isoforms found by StringTie\nwith access to ICE predictions");
dev.off();
