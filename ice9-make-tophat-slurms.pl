...
foreach my $subdir (@dirs) {
  ...
  $slurm->addCommand("cd $dir; $PROGRAM $MIN_FPKM $MIN_READS $subdir 1.ice9.gff 1 RNA/junctions.bed ALT 1.blacklist 1.ice9-nmd 1.readcounts-ice9-fpkm3 > 1.tophat-validation-ice9");
  $slurm->addCommand("cd $dir; $PROGRAM $MIN_FPKM $MIN_READS $subdir 2.ice9.gff 2 RNA/junctions.bed ALT 2.blacklist 2.ice9-nmd 2.readcounts-ice9-fpkm3 > 2.tophat-validation-ice9");
