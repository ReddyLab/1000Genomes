...
my $SLURMS="$THOUSAND/assembly/new-RNA-slurms";
...
tophat2 --output-dir $dir/newRNA --min-intron-length 30 --num-threads $CPUs --GTF $dir/newRNA/1and2.gff 1and2 $FASTQ/$rnaID\_1.fastq.gz $FASTQ/$rnaID\_2.fastq.gz

/data/reddylab/software/stringtie/stringtie-1.2.1.Linux_x86_64/stringtie accepted_hits.bam -G $dir/newRNA/1and2.gff -o $dir/newRNA/stringtie.gff -p $CPUs
